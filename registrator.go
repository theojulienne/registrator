...
var registerInternalAddress = flag.Bool("reg-use-internal", false, "Whether to register all published ports with the internal docker address instead of the external address")
